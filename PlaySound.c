...
#include "Play_Sound.h"//PlaySound()
...
int main(int argc, char *argv[]) {
    ...
    //legacy WINAPI PlaySound() function to play sound
    PlaySoundA(file,NULL, SND_ASYNC);//PlaySound(file,NULL, SND_ASYNC);
    ...
    //legacy WINAPI PlaySound() function to stop sound
    PlaySound(NULL, 0, 0);//PlaySoundA(NULL, 0, 0);
